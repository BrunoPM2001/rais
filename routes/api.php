...
Route::prefix('admin')->middleware('checkRole:Usuario_admin')->group(function () {
  ...
  Route::prefix('reportes')->group(function () {
    ...
    Route::get('estudio/tipos', [EstudioController::class, 'tiposProyecto']);
    Route::get('estudio/periodos/{tipo}', [EstudioController::class, 'periodosPorTipo']);
  ...
  Route::prefix('admin')->group(function () {
    ...
    Route::prefix('lineasInvestigacion')->group(function () {
      ...
      Route::post('excel', [Linea_investigacionController::class, 'excel']);
      Route::post('pdf', [Linea_investigacionController::class, 'pdf']);
    });
...
Route::prefix('investigador')->middleware('checkRole:Usuario_investigador')->group(function () {
  ...
  Route::prefix('informes')->group(function () {
    ...
    Route::prefix('informe_economico')->group(function () {
      ...
      Route::post('eliminarTransferenciaTemporal',[Informe_economicoController::class, 'eliminarTransferenciaTemporal']);
