...
class InformePicvController extends S3Controller {
  ...
  public function presentar(Request $request) {
    ...
    $count2 = DB::table('Proyecto_doc')
      ->where('proyecto_id', '=', $request->input('proyecto_id'))
      ->where('categoria', '=', 'informe-PICV-INFORME')
      ->where('nombre', '=', 'Archivos de informe final')
      ->where('estado', '=', 1)
      ->count();

    if ($count2 == 0) {
      return ['message' => 'error', 'detail' => 'Necesita cargar el archivo del Informe Final'];
    }
  ...
  public function reporte(Request $request) {
    ...
    $pdf = Pdf::loadView('admin.estudios.informes_tecnicos.proctie', [
      'proyecto' => $proyecto,
      'miembros' => $miembros,
      'archivos' => $archivos,
      'detalles' => $detalles,
