...
class ProCtieController extends Controller {

    public function detalle(Request $request) {
        // Detalle del proyecto, incluyendo información relacionada con la línea de investigación, grupo, facultad, y documentos
    ...
    public function miembros(Request $request) {
        // Recupera los integrantes del proyecto con detalles sobre su tipo y documentos asociados
    ...
    public function descripcion(Request $request) {
        // Recupera las descripciones del proyecto en base a su código
    ...
    public function actividades(Request $request) {
        // Recupera las actividades asociadas al proyecto
    ...
    public function documentos(Request $request) {
        // Obtiene los documentos del proyecto relacionados con la carta de compromiso del asesor
    ...
    public function reporte(Request $request) {
        // Genera un reporte en PDF con todos los detalles del proyecto, actividades, presupuesto, etc.
