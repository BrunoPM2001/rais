...
<body>
  ...
  <div class="cuerpo">
    ...
    <p>
      ...
      {{ $patente->nro_registro == null ? 'No tiene número' : $patente->nro_registro }}
    </p>
    <p>
      <b>1.2 Título: </b>
      {{ $patente->titulo }}
    ...
    <table class="table">
      <thead>
        <tr>
          <th style="width: 15%;" align="left">Titulares</th>
        </tr>
      </thead>
      <tbody>
    ...
    <h5>III. Inventores:</h5>

    <table class="table">
      <thead>
        <tr>
          <th style="width: 20%;" align="left">Presentador</th>
          <th style="width: 30%;" align="left">Tipo de integrante</th>
          <th style="width: 30%;" align="left">Nombres</th>
          <th style="width: 20%;" align="left">Condicion</th>
        </tr>
      </thead>
      <tbody>
        @if (sizeof($autores) == 0)
