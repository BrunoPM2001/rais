...
<body>
  ...
  <p class="titulo">
    <strong>
      Programa de promoción de tesis de posgrado para docentes de la UNMSM {{ $proyecto->periodo }}<br><br>
      {{ $proyecto->informe }}<br>
  ...
  <div class="cuerpo">
    ...
    <table class="tableData">
      <tbody>
        <tr>
          <td style="width: 16%;" valign="top"><strong>1.1 Tipo de tesis</strong></td>
          <td style="width: 1%;" valign="top">:</td>
          <td style="width: 83%;" valign="top">{{ $proyecto->tipo_proyecto }}</td>
        </tr>
        <tr>
          <td style="width: 16%;"><strong>1.2 Facultad</strong></td>
          <td style="width: 1%;">:</td>
          <td style="width: 83%;">{{ $proyecto->facultad }}</td>
        </tr>
        <tr>
          <td style="width: 16%;" valign="top"><strong>1.3 Título de la tesis</strong></td>
          <td style="width: 1%;" valign="top">:</td>
          <td style="width: 83%;" valign="top">{{ $proyecto->titulo }}</td>
        </tr>
        <tr>
          <td style="width: 16%;"><strong>1.4 Resolución</strong></td>
          <td style="width: 1%;">:</td>
          <td style="width: 83%;">{{ $proyecto->resolucion_rectoral }}</td>
        </tr>
        <tr>
          <td style="width: 16%;"><strong>1.5 Código de proyecto de tesis</strong></td>
          <td style="width: 1%;">:</td>
          <td style="width: 83%;">{{ $proyecto->codigo_proyecto }}</td>
        </tr>
        <tr>
          <td style="width: 16%;"><strong>1.6 Asesor</strong></td>
          <td style="width: 1%;">:</td>
