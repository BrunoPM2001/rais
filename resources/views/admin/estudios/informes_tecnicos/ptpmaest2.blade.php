...
<body>
  ...
  <p class="titulo">
    <strong>
      Programa de promoción de tesis de posgrado para docentes de la UNMSM {{ $proyecto->periodo }}
    </strong>
  </p>
  ...
  <div class="cuerpo">
    ...
    <table class="tableData">
      <tbody>
        <tr>
          <td style="width: 24%;" valign="top"><strong>Tesis</strong></td>
          <td style="width: 1%;" valign="top">:</td>
          <td style="width: 75%;" valign="top">Posgrado: Maestría</td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="width: 24%;" valign="top"><strong>Título de tesis</strong></td>
          <td style="width: 1%;" valign="top">:</td>
        ...
        <tr>
          <td style="width: 24%;" valign="top"><strong>Código del proyecto de tesis</strong></td>
          <td style="width: 1%;" valign="top">:</td>
    ...
    <h6>2.1 Entregables:</h6>
    <div class="desc">
      <strong>Tesis concluída y aprobada: </strong>
      @if (isset($archivos['informe-PTPMAEST-INFORME-FINAL-tesis']))
        Sí
      @else
        No
      @endif
      <br>
      <strong>Acta de sustentación: </strong>
      @if (isset($archivos['informe-PTPMAEST-INFORME-FINAL-acta']))
        Sí
      @else
        No
      @endif
    ...
    <h6>2.2. Resultados indirectos:</h6>
    <div class="desc">
      {!! $detalles->infinal1 !!}
    </div>

    <h6>2.3 Problemas identificados:</h6>
    <div class="desc">
      {!! $detalles->infinal2 !!}
    </div>
