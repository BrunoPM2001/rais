  ...
  <div class="cuerpo">
    ...
    <table class="tableData">
      <tbody>
        ...
        <tr>
          <td style="width: 24%;" valign="top"><strong>Productos de investigación</strong></td>
          <td style="width: 1%;" valign="top">:</td>
          <td style="width: 75%;" valign="top">{{ $detalles->estado_trabajo }}</td>
        </tr>
      </tbody>
    </table>
    ...
    <h6>2.1. Informe de trabajo de investigación:</h6>
    <div class="desc">
      {!! $detalles->infinal10 !!}
    </div>

    <h6>2.2. Otros productos de investigación:</h6>
    <div class="desc">
      {!! $detalles->infinal9 !!}
    </div>
    ...
    <div class="desc">
      @if (isset($archivos['informe-PTPBACHILLER-INFORME']))
        Sí
      @else
        No
      @endif
