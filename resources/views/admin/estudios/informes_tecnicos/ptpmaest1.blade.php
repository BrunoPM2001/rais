...
<body>
  ...
  <div class="cuerpo">
    ...
    <h6>2.1. Porcentaje estimado de avance:</h6>
    <div class="desc">
      {!! $detalles->infinal7 !!}
    </div>

    <h6>2.2. Actividades realizadas:</h6>
    <div class="desc">
      {!! $detalles->infinal1 !!}
    </div>
    
    <h6>2.3 Medios probatorios:</h6>
    <div class="desc">
      @if (isset($archivos['informe-PTPMAEST-INFORME-AVANCE']))
      Sí
      @else
      No
      @endif
    ...
    <h6>2.4 Evaluación global de ejecución académica:</h6>
    <div class="desc">
      {!! $detalles->infinal3 !!}
    </div>
