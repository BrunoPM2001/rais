...
<body>
  ...
  <table class="table-texto3">
    <tr>
      <td>Actualmente, registra participación en el(los) siguiente(s) Grupo(s) de investigación:</td>
    </tr>
  </table>
  ...
  <table class="table-content">
    ...
    <tbody>
      @foreach ($grupoH as $itemh)
        <tr>
          <td style="width: 20%;">{{ $itemh->grupo_nombre_corto }}</td>
